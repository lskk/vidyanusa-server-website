...
<head>
    ...
    <link rel="shortcut icon" href="{{url('/')}}/core/resources/assets/img/shorcut-icon.png">

    <link rel="stylesheet" href="{{url('/')}}/core/resources/assets/css/bootstrap.css">

    <link rel="stylesheet" href="{{url('/')}}/core/resources/assets/css/animate.css">
    <link rel="stylesheet" href="{{url('/')}}/core/resources/assets/css/font-awesome.min.css">
    <link rel="stylesheet" href="{{url('/')}}/core/resources/assets/css/slick.css">
    <link rel="stylesheet" href="{{url('/')}}/core/resources/assets/css/settings.css">

    <link rel="stylesheet" href="{{url('/')}}/core/resources/assets/css/freeze.css">
...
<div class="pre-loader">
    <div class="load-con">
        <img src="{{url('/')}}/core/resources/assets/img/freeze/logo.png" class="animated fadeInDown" alt="">
        <div class="spinner">
        ...
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{{url('/')}}">
                    <img src="{{url('/')}}/core/resources/assets/img/freeze/logo.png" alt="" class="logo">
                </a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="daftar/guru">daftar</a>
                    </li>
                    <li><a href="#support">dukungan</a>
                    </li>
                    <li><a href="login">masuk</a>
        ...
        <div class="tp-banner" >
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    <!-- MAIN IMAGE -->
                    <img src="{{url('/')}}/core/resources/assets/img/transparent.png"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption lfl fadeout hidden-xs"
                        ...
                        <img src="{{url('/')}}/core/resources/assets/img/freeze/Slides/hand-freeze.png" alt="">
                    </div>
                    ...
                    <div class="tp-caption lfl fadeout visible-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="{{url('/')}}/core/resources/assets/img/freeze/iphone-freeze.png" alt="">
                    </div>
                    ...
                    <div class="tp-caption sfr hidden-xs" data-x="860" data-y="center" data-hoffset="0" data-voffset="85" data-speed="1500" data-start="1900" data-easing="Power4.easeOut">
                        <a href="#" class="btn btn-default btn-lg">Masuk</a>
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption customin customout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="{{url('/')}}/core/resources/assets/img/freeze/Slides/family-freeze.png" alt="">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption lfb fadeout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="{{url('/')}}/core/resources/assets/img/freeze/Slides/freeze-slide2.png" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4" >
                    <img src="{{url('/')}}/core/resources/assets/img/freeze/iphone-freeze.png"
                    ...
                    <div class="review-filtering">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="{{url('/')}}/core/resources/assets/img/scott.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                        ...
                        <div class="review rollitin">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="{{url('/')}}/core/resources/assets/img/pakari.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="review-comment">
                        ...
                        <div class="review rollitin">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="{{url('/')}}/core/resources/assets/img/escher.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="review-comment">
                        ...
                        <div class="review rollitin">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="{{url('/')}}/core/resources/assets/img/charlie.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="review-comment">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                        <img src="{{url('/')}}/core/resources/assets/img/freeze/freeze-angled2.png" alt="">
                    </div>
                    <div class="platforms">
...
<script src="{{url('/')}}/core/resources/assets/js/jquery-1.11.1.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/bootstrap.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/slick.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/placeholdem.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/rs-plugin/js/jquery.themepunch.plugins.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/waypoints.min.js"></script>
<script src="{{url('/')}}/core/resources/assets/js/scripts.js"></script>
