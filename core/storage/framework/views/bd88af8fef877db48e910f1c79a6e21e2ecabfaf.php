        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <?php /*<li><a href="#"> <div class="padding10">User Online : <span id="cnt_ol" style="font-weight: bold"></span></div></a>
                    </li>*/ ?>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div class="tp-banner" >
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/transparent.png"  alt="slidebg1"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 1 -->
                    <div class="tp-caption lfl fadeout hidden-xs"
                        ...
                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/freeze/Slides/hand-freeze.png" alt="">
                    </div>
                    ...
                    <div class="tp-caption lfl fadeout visible-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/freeze/iphone-freeze.png" alt="">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption customin customout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/freeze/Slides/family-freeze.png" alt="">
                    </div>
                ...
                <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                    ...
                    <div class="tp-caption lfb fadeout hidden-xs"
                         ...
                         data-start="700"
                         data-easing="Power4.easeOut">
                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/freeze/Slides/freeze-slide2.png" alt="">
                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4" >
                    <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/freeze/iphone-freeze.png"
    ...
    <section id="reviews">
        <div class="container">
            <div class="section-heading inverse scrollpoint sp-effect3">
                <h1>Reviews</h1>
                <div class="divider"></div>
                <?php /*<p>Read What's The People Are Saying About Us</p>*/ ?>
            </div>
            <div class="row">
                    ...
                    <div class="review-filtering">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/scott.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                        ...
                        <div class="review rollitin">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/pakari.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="review-comment">
                        ...
                        <div class="review rollitin">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/escher.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="review-comment">
                        ...
                        <div class="review rollitin">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="review-person">
                                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/charlie.jpg" alt="" class="img-responsive">
                                    </div>
                                </div>
                                <div class="col-md-10">
                                    <div class="review-comment">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="hanging-phone scrollpoint sp-effect2 hidden-xs">
                        <img src="<?php echo e(url('/')); ?>/core/resources/assets/img/freeze/freeze-angled2.png" alt="">
                    </div>
                    <div class="platforms">
